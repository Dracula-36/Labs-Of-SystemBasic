...
08048c9e <func4>:
 ...
 8048ce0:	7d 17                	jge    8048cf9 <func4+0x5b> ;x = ecx

 8048ce2:	89 5c 24 08          	mov    %ebx,0x8(%esp)       ;0xe -> b
 8048ce6:	83 c1 01             	add    $0x1,%ecx
 8048ce9:	89 4c 24 04          	mov    %ecx,0x4(%esp)       ;ecx+1 -> a
 8048ced:	89 14 24             	mov    %edx,(%esp)          ;x -> x
 8048cf0:	e8 a9 ff ff ff       	call   8048c9e <func4>      
 8048cf5:	8d 44 00 01          	lea    0x1(%eax,%eax,1),%eax;eax*2+1 -> eax
...
08048cff <phase_4>:
 ...
 8048d12:	c7 44 24 04 0f a3 04 	movl   $0x804a30f,0x4(%esp)
 8048d19:	08 
...
08048d68 <phase_5>:
 8048d68:	83 ec 2c             	sub    $0x2c,%esp
 8048d6b:	8d 44 24 1c          	lea    0x1c(%esp),%eax
 8048d6f:	89 44 24 0c          	mov    %eax,0xc(%esp)
 8048d73:	8d 44 24 18          	lea    0x18(%esp),%eax
 8048d77:	89 44 24 08          	mov    %eax,0x8(%esp)
 8048d7b:	c7 44 24 04 0f a3 04 	movl   $0x804a30f,0x4(%esp)
 8048d82:	08 
 8048d83:	8b 44 24 30          	mov    0x30(%esp),%eax
...
08048f70 <sig_handler>:
 ...
 8048f73:	c7 04 24 00 a2 04 08 	movl   $0x804a200,(%esp)
 ...
 8048f8b:	c7 44 24 04 c2 a2 04 	movl   $0x804a2c2,0x4(%esp)
 8048f92:	08 
 ...
 8048fb8:	c7 04 24 ca a2 04 08 	movl   $0x804a2ca,(%esp)
...
08048fd0 <invalid_phase>:
 ...
 8048fdb:	c7 44 24 04 d2 a2 04 	movl   $0x804a2d2,0x4(%esp)
 8048fe2:	08 
...
08049125 <explode_bomb>:
 ...
 8049128:	c7 04 24 e3 a2 04 08 	movl   $0x804a2e3,(%esp)
 804912f:	e8 bc f6 ff ff       	call   80487f0 <puts@plt>
 8049134:	c7 04 24 ec a2 04 08 	movl   $0x804a2ec,(%esp)
...
0804914c <read_six_numbers>:
 ...
 804917a:	c7 44 24 04 03 a3 04 	movl   $0x804a303,0x4(%esp)
 8049181:	08 
...
0804919c <read_line>:
 ...
 80491b8:	c7 04 24 15 a3 04 08 	movl   $0x804a315,(%esp)
 ...
 80491d0:	c7 04 24 33 a3 04 08 	movl   $0x804a333,(%esp)
 ...
 80491ff:	c7 04 24 15 a3 04 08 	movl   $0x804a315,(%esp)
 ...
 8049241:	c7 04 24 3e a3 04 08 	movl   $0x804a33e,(%esp)
 ...
 8049263:	be 59 a3 04 08       	mov    $0x804a359,%esi
...
08049340 <sigalrm_handler>:
 ...
 804934a:	00 
 804934b:	c7 44 24 08 c8 a3 04 	movl   $0x804a3c8,0x8(%esp)
 8049352:	08 
...
08049483 <submitr>:
 ...
 80497e7:	c7 44 24 0c d4 a4 04 	movl   $0x804a4d4,0xc(%esp)
 80497ee:	08 
 ...
 80499a0:	c7 44 24 04 db a4 04 	movl   $0x804a4db,0x4(%esp)
 80499a7:	08 
 ...
 80499d2:	c7 44 24 0c ec a3 04 	movl   $0x804a3ec,0xc(%esp)
 80499d9:	08 
 ...
 8049bc5:	c7 44 24 0c 1c a4 04 	movl   $0x804a41c,0xc(%esp)
 8049bcc:	08 
...
08049cce <init_driver>:
 ...
 8049d90:	c7 04 24 ec a4 04 08 	movl   $0x804a4ec,(%esp)
 ...
 8049e76:	c7 44 24 10 ec a4 04 	movl   $0x804a4ec,0x10(%esp)
 8049e7d:	08 
 8049e7e:	c7 44 24 0c ac a4 04 	movl   $0x804a4ac,0xc(%esp)
 8049e85:	08 
...
08049edc <driver_post>:
 ...
 8049ef7:	c7 44 24 04 fa a4 04 	movl   $0x804a4fa,0x4(%esp)
 8049efe:	08 
 ...
 8049f30:	c7 44 24 10 11 a5 04 	movl   $0x804a511,0x10(%esp)
 8049f37:	08 
 8049f38:	89 44 24 0c          	mov    %eax,0xc(%esp)
 8049f3c:	c7 44 24 08 19 a5 04 	movl   $0x804a519,0x8(%esp)
 8049f43:	08 
 8049f44:	c7 44 24 04 6e 3b 00 	movl   $0x3b6e,0x4(%esp)
 8049f4b:	00 
 8049f4c:	c7 04 24 ec a4 04 08 	movl   $0x804a4ec,(%esp)
